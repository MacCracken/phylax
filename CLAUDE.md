...
- **sakshi** 2.2.4 — structured logging (`dist/sakshi.cyr` bundle)
- **sigil** 3.1.1 — cryptographic primitives (SHA-256, SHA-NI dispatch)
- **majra** 2.4.4 — pubsub/counter (transitively via bote events_majra)
- **bote** 2.7.1 — MCP tool registry and dispatch
