...
- **sigil** 3.8.0 — cryptographic primitives (SHA-256, SHA-NI dispatch)
- **majra** 2.4.7 — pubsub/counter (transitively via bote events_majra)
- **bote** 2.7.6 — MCP tool registry and dispatch
- **libro** 2.7.4 — explicit pin matching bote's transitive libro pin
